...
PLANTED_VULNS: List[Dict[str, str]] = [
    ...
    # ---- D19 业务场景层 · 社交/医疗/游戏/外卖/招聘/直播/会员/政务 ----
    {"vuln_id": "V-38", "category": "soc_content_idor", "guard": "post_scope_check",
     "surface": "api", "desc": "私密帖子越权访问"},
    {"vuln_id": "V-39", "category": "soc_moderation_bypass", "guard": "moderation_filter",
     "surface": "api", "desc": "内容审核绕过（违禁词变形直接发布）"},
    {"vuln_id": "V-40", "category": "med_record_idor", "guard": "record_scope_check",
     "surface": "api", "desc": "病历越权访问（含诊断/处方）"},
    {"vuln_id": "V-41", "category": "med_appointment_race", "guard": "appointment_lock",
     "surface": "api", "desc": "号源并发抢占（无号源锁）"},
    {"vuln_id": "V-42", "category": "game_currency_tamper", "guard": "game_currency_server_side",
     "surface": "api", "desc": "游戏币余额客户端直改"},
    {"vuln_id": "V-43", "category": "game_item_dup", "guard": "reward_idempotency",
     "surface": "api", "desc": "道具重复领取（幂等缺失）"},
    {"vuln_id": "V-44", "category": "dlv_fee_tamper", "guard": "fee_server_side",
     "surface": "api", "desc": "配送费客户端篡改"},
    {"vuln_id": "V-45", "category": "dlv_confirm_bypass", "guard": "delivery_confirm_check",
     "surface": "api", "desc": "未送达直接确认（无骑手凭证）"},
    {"vuln_id": "V-46", "category": "hr_resume_idor", "guard": "resume_scope_check",
     "surface": "api", "desc": "简历越权查看（含联系方式）"},
    {"vuln_id": "V-47", "category": "hr_offer_bypass", "guard": "interview_workflow",
     "surface": "api", "desc": "面试流程跳步（未初试直接终面）"},
    {"vuln_id": "V-48", "category": "med_gift_amount", "guard": "gift_price_server_side",
     "surface": "api", "desc": "打赏金额客户端篡改（负数价格）"},
    {"vuln_id": "V-49", "category": "med_paywall_bypass", "guard": "paywall_check",
     "surface": "api", "desc": "付费内容越权播放（未订阅取流）"},
    {"vuln_id": "V-50", "category": "mem_subscription_bypass", "guard": "subscription_server_side",
     "surface": "api", "desc": "试用周期客户端重置"},
    {"vuln_id": "V-51", "category": "mem_points_farm", "guard": "points_idempotency",
     "surface": "api", "desc": "积分任务重复领取刷量"},
    {"vuln_id": "V-52", "category": "gov_workflow_jump", "guard": "workflow_state_machine",
     "surface": "api", "desc": "办事流程跳步（未提交材料直接办结）"},
    {"vuln_id": "V-53", "category": "gov_data_idor", "guard": "citizen_scope_check",
     "surface": "api", "desc": "公民信息越权查询（身份证号）"},
]
